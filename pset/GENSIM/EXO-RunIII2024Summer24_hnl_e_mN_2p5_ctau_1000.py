...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
   args = cms.vstring('root://cmsxrootd.fnal.gov//store/user/kkwok/llp/gridpack/run3/HNL_e_mN_2p5_ctau_1000_13p6TeV_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
