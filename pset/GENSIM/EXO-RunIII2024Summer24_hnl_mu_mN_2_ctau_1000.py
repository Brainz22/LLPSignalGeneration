...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
   args = cms.vstring('root://cmsxrootd.fnal.gov//store/user/kkwok/llp/gridpack/run3/HNL_mu_mN_2_ctau_1000_13p6TeV_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
